...
\vskip 6pt
\hangpara
Dellwo, V., He, L., \& \textbf{Vyshnevetska, V}. [accepted] Rhythmic-temporal variability between speakers and its use in forensic speaker comparison. In F. Nolan, K. McDougall, T. Hudson (Eds.): \textit{Oxford Handbook of Forensic Phonetics}
...
\vskip 6pt
\hangpara
{\bf 2025}\hspace{1ex} \textbf{Vyshnevetska, Valeriia}, Giroud, N., Meyer, M., \& Dellwo, V. [under review] Neural speech tracking is modulated by voice identity, but not by voice familiarity. {\it OSF Preprints}. \url{https://doi.org/10.31219/osf.io/kcwb2_v1}.
\vskip 6pt
\hangpara
