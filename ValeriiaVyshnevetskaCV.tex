...
Andreasstrasse 15, 4.56 & \href{https://orcid.org/0009-0003-3355-9580}{ORCID iD} \\
...
& Forensic consultant (\href{https://www.jpfrench.com/valeriia-vyshnevetska/}{Webpage}) \\
\bf 2025-- & {\bf The LINGUIST List} \\
& Managing editor (\href{https://linguistlist.org/}{Webpage}) \\
...
\vskip 6pt
\hangpara
{\bf 2025}\hspace{1ex} \textbf{Vyshnevetska, Valeriia}, Giroud, N., Ramon, M., \& Dellwo, V. Listeners are biased towards voices of young speakers and female speakers when discriminating voices. \textit{Cognitive Research: Principles and Implications}. \url{https://doi.org/10.1186/s41235-025-00636-3}.
\vskip 6pt
\hangpara
{\bf 2023}\hspace{1ex} \textbf{Perepelytsia, Valeriia} \& Dellwo, V. Acoustic compression in Zoom audio does not compromise voice recognition performance. \textit{Scientific Reports}. \url{https://doi.org/10.1038/s41598-023-45971-x}.
...
\vskip 6pt
\hangpara
\textbf{Vyshnevetska, Valeriia}, Kathiresan, T., Cordonnier, G., Pellegrino, E., \& Dellwo, V. [accepted] SEE-U-VR: A novel method for eliciting different speaking styles  using virtual reality. In E. Glaser, J. Kabatek, B. Sonnenhauser (Eds.): \textit{Sprachenräume der Schweiz. Band 2.}
\vskip 6pt
\hangpara
Dellwo, Volker, He, L., \& \textbf{Vyshnevetska, V}. [accepted] Rhythmic-temporal variability between speakers and its use in forensic speaker comparison. In F. Nolan, K. McDougall, T. Hudson (Eds.): \textit{Oxford Handbook of Forensic Phonetics}
...
\vskip 6pt
\hangpara
{\bf 2023}\hspace{1ex} \textbf{Perepelytsia, Valeriia}, Bradshaw, L., \& Dellwo, V. IDEAR: A speech database of identity-marked, clear, and read speech. \textit{Proceedings of the 20th International Congress of Phonetic Sciences}, 3216-3220, Prague, Czech Republic. \url{https://doi.org/10.5167/uzh-236804}.
\vskip 6pt
\hangpara
{\bf 2023}\hspace{1ex} Bradshaw, L., \textbf{Perepelytsia, V.}, \& Dellwo, V. Vocal effort in human interactions with voice-AI. \textit{Proceedings of the 20th International Congress of Phonetic Sciences}, 803-807, Prague, Czech Republic. \url{https://doi.org/10.5167/uzh-255338}.
...
\vskip 6pt
\hangpara
{\bf 2024}\hspace{1ex} Prasad, Amrita, Shahreza, H. O., Carofilis, A., Farhadipour, A., Liu, S., Madikeri, S., George, A., Motlicek, P., Marcel, S., Chapariniya, M., \textbf{Perepelytsia, V.}, Vukovic, T., \& Dellwo, V. \textit{Team Switzerland submission to NIST SRE24 speaker recognition evaluation.}
...
\vskip 6pt
\hangpara
{\bf 2026}\hspace{1ex} \textbf{Vyshnevetska, Valeriia}, De Luca, A., Lavan, N., McGettigan, C., Cooney, G., Reece, A., \& Dellwo, V. CANDORspeech: A large-scale corpus of phonetically annotated conversational speech from dyadic online conversations with human quality control (Version 1.0) [Data set]. {\it LaRS - Language Repository of Switzerland}. \url{https://doi.org/10.48656/2739-pz72}.

\vskip 6pt
\hangpara
{\bf 2025}\hspace{1ex} Friedrichs, Daniel, \textbf{Vyshnevetska, V.}, Lancheros Pompeyo, M., Bolt, E., Dellwo, V., \& Moran, S. A multimodal speech-production dataset with time-aligned articulography, EEG, audio, and vocal-tract anatomy (Version 1.0) [Data set]. {\it LaRS - Language Repository of Switzerland}.
...
\vskip 6pt
\hangpara
{\bf 2026}\hspace{1ex} Farhadipour, Aref, Jin, M., \textbf{Vyshnevetska, V.}, Li, X., Pellegrino, E., \&  Madikeri, S. Spoofing-aware speaker verification via wavelet prompt tuning and multi-model ensembles (Version 1). \textit{arXiv}. \url{https://doi.org/10.48550/ARXIV.2601.17557}.
\vskip 6pt
\hangpara
{\bf 2025}\hspace{1ex} \textbf{Vyshnevetska, Valeriia}, Giroud, N., Meyer, M., \& Dellwo, V. Neural speech tracking is modulated by voice identity, but not by voice familiarity. {\it OSF Preprints}. \url{https://doi.org/10.31219/osf.io/kcwb2_v1}.
\vskip 6pt
\hangpara
{\bf 2025}\hspace{1ex} Farhadipour, Aref, Liu, S., Chapariniya, M., \textbf{Vyshnevetska, V.}, Madikeri, S., Vukovic, T., \& Dellwo, V. CL-UZH submission to the NIST SRE 2024 Speaker Recognition Evaluation. \textit{arXiv}
\url{https://doi.org/10.48550/arXiv.2510.00952}
...
\hangpara
{\bf 2025}\hspace{1ex}“Are female voices more recognizable than male voices?” Jamagishi Lab, National Institute of Informatics. November 11. Tokyo, Japan. 
...
\vskip 6pt
\hangpara
{\bf 2026}\hspace{1ex}“Human neural networks are the most efficient large language models”. Paper presented at the 35th Joint Workshop on Linguistics and Language Processing (JWLLP 35), Institute for the Study of Language and Information (ISLI), Kyung Hee University. April 18. Seoul, South Korea.

\vskip 6pt
\hangpara
{\bf 2025}\hspace{1ex} “CANDORspeech: A large-scale corpus of phonetically annotated conversational speech from dyadic online conversations with human quality control”. Poster to be presented at the 33rd Annual Conference of the International Association for Forensic Phonetics and Acoustics (IAFPA). July 20--23. The Hague, Netherlands.
...
\hangpara
{\bf 2025}\hspace{1ex} Hill, H.M. "Deepfake, earwitnesses, and discrimination: Your voice matters". Psychonomic Society Featured Content. \url{https://featuredcontent.psychonomic.org/deepfake-earwitnesses-and-discrimination-your-voice-matters/}.
...
\vskip 6pt
\hangpara
{\bf 2019-2025}\hspace{1ex}Travel grants for conference travel, University of Zurich, Switzerland. %(CHF 2122)
...
\end{flushleft}
\hangpara
{\bf 2025}\hspace{1ex} Reviewer, Interspeech 2025.
\vskip 6pt
\hangpara
...
\end{flushleft}
\hangpara
{\bf 2025}\hspace{1ex}Reviewer for \textit{Neuropsychologia}
\vskip 6pt
\hangpara
...
\item Centre for Forensic Phonetics and Acoustics (CFPA), University of Zurich
...
\item {\bf English} expert
\item {\bf German} proficient
\item {\bf French} proficient
\end{itemize}
